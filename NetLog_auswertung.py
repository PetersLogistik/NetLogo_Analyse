...
@Date: 18.03.2023
@Funktion:  
    1a. CSV-Datensätze mit Python einlesen 
    1b. Trajektorien mit mathplotlib plotten ~ analog zu der Darstellung in NetLogo. X-Achese: -26 to 26 Y-Achse: Zeit
    2. Fundamentaldiagramm (v - p) erstellen
    3. Fitten des Fundamentaldiagramms 
    4. individuelle bzw. mikroskopische Fundamentaldiagramm erzeugen
"""
...
plt.style.use('ggplot') # Desingstyle (R)

# Globales
url = r".\NetLogo_Analyse"
